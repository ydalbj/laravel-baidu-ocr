...
class AipBase {
     ...
     */
    public function __construct(string $appId, string $apiKey, string $secretKey, string $path = '')
    {
    ...
    private function getAuthFilePath(){
        return ($this->authFilePath ?: dirname(__FILE__)) . DIRECTORY_SEPARATOR . md5($this->apiKey);
    }
